...
<body>
    <div class="my-5 mx-5">
        ...
        @endif
        <form class="row container" action="{{ route('update', ['id' => $data->id]) }}" method="post">
            @csrf
            ...
            <div class="col-4 mb-3">
                ...
                <select name="category" class="form-select" aria-label="Default select example">
                    <option disabled> -- Chọn thể loại chi phí --</option>
                    <option value="travel" {{ $data->category == 'travel' ? 'selected' : '' }}>Du lịch</option>
                    <option {{ $data->category == 'food' ? 'selected' : '' }} value="food">Đồ ăn</option>
                    <option {{ $data->category == 'shopping' ? 'selected' : '' }} value="shopping">Mua sắm</option>
                    <option {{ $data->category == 'other' ? 'selected' : '' }} value="other">Khác</option>
                </select>
            </div>
            ...
            <div class="col-4 mb-3">
                ...
                <input type="date" name="date_trip" value="{{ $data->date_trip }}" class="form-control"
                    id="date_trip">
            </div>
            ...
            <div class="col-4 mb-3">
                ...
                <input type="number" min="100000" max="10000000" step="10000" name="expense"
                    value="{{ $data->expense }}" class="form-control" id="expense">
            </div>
            ...
            <div class="col-4 mb-3">
                ...
                <input type="number" min="100000" max="10000000" step="10000" name="total"
                    value="{{ $data->total }}" class="form-control" id="total">
            </div>
